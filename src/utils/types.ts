...
// Kanban WS messages
export type WSKanbanMessage = WSKanbanInput | WSKanbanResponse;
 ...
 */
export type ChatNotification = ChatCountNotification;
...
export type WSMessage = WSInputMessage | WSResponseMessage;
